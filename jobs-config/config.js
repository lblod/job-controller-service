const TASK_HARVESTING_COLLECTING = 'http://lblod.data.gift/vocabularies/jobs/concept/TaskType/collecting';
const TASK_HARVESTING_IMPORTING = 'http://lblod.data.gift/vocabularies/jobs/concept/TaskType/importing';
const TASK_HARVESTING_REPARING = 'http://lblod.data.gift/vocabularies/jobs/concept/TaskType/reparing';
const TASK_HARVESTING_VALIDATING = 'http://lblod.data.gift/vocabularies/jobs/concept/TaskType/validating';
const TASK_HARVESTING_MIRRORING = 'http://lblod.data.gift/vocabularies/jobs/concept/TaskType/mirroring';

//Some declarative boilerplate to manage the task order of the job. Will probably be prettier later
export default {
  'http://lblod.data.gift/vocabularies/jobs/concept/JobType/lblodHarvesting': {
